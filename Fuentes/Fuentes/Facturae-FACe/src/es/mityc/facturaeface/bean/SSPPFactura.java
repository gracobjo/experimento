...
public class SSPPFactura  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webservice.face.gob.es", "SSPPFactura"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webservice.face.gob.es", "SSPPFicheroFactura"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ficheros_anexos");
        elemField.setXmlName(new javax.xml.namespace.QName("", "ficheros_anexos"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://webservice.face.gob.es", "SSPPFicheroAnexo"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
