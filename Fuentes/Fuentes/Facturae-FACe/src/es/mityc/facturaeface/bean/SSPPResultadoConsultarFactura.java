...
public class SSPPResultadoConsultarFactura  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webservice.face.gob.es", "SSPPResultadoConsultarFactura"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webservice.face.gob.es", "SSPPResultadoConsultarFacturaEstado"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
