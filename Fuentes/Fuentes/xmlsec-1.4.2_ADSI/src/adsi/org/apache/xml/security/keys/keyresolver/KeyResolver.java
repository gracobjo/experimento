...
public class KeyResolver {
   ...
   /**
    * The init() function is called by adsi.org.apache.xml.security.Init.init()
    */
    ...
    * available to <I>all</I> {@link adsi.org.apache.xml.security.keys.KeyInfo} objects. This means that
    * personalized {@link KeyResolverSpi}s should only be registered directly
    * to the {@link adsi.org.apache.xml.security.keys.KeyInfo} using 
    * {@link adsi.org.apache.xml.security.keys.KeyInfo#registerInternalKeyResolver}.
    *
    * @param className
 * @throws InstantiationException 
 * @throws IllegalAccessException 
 * @throws ClassNotFoundException 
    ...
    * available to <I>all</I> {@link adsi.org.apache.xml.security.keys.KeyInfo} objects. This means that
    * personalized {@link KeyResolverSpi}s should only be registered directly
    * to the {@link adsi.org.apache.xml.security.keys.KeyInfo} using {@link adsi.org.apache.xml.security.keys.KeyInfo#registerInternalKeyResolver}.
    *
    * @param className
    */
