 ...
 * {@link adsi.org.apache.xml.security.keys.storage.StorageResolver}.
 *
...
public class KeyStoreResolver extends StorageResolverSpi {
   ...
   public static void main(String unused[]) throws Exception {
      ...
      for (Iterator i = krs.getIterator(); i.hasNext(); ) {
         ...
         byte[] ski =
            adsi.org.apache.xml.security.keys.content.x509.XMLX509SKI
               .getSKIBytesFromCert(cert);

         System.out.println(adsi.org.apache.xml.security.utils.Base64.encode(ski));
      }
   }
}
