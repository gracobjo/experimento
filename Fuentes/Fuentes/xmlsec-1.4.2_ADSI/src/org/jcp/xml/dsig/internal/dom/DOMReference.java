 ...
 */
/*
 * $Id: DOMReference.java 647272 2008-04-11 19:22:21Z mullan $
 */
...
public final class DOMReference extends DOMStructure 
    ...
    */
    ...
    static {
	try {
            useC14N11 = Boolean.getBoolean("adsi.org.apache.xml.security.useC14N11");
        } catch (Exception e) {
            // ignore exceptions
       }
    }
	...
	try {
		...
		String c14nalg = CanonicalizationMethod.INCLUSIVE;
		    ...
		    if (!c14n11) {
			    ...
			    ("adsi.org.apache.xml.security.useC14N11");
