...
export class FacturaeValidator {
   ...
   */
  private static validateForAEAT(xmlDoc: Document, result: ExternalSystemValidation): void {
    result.requirements = [
   ...
   */
  private static validateForFACE(xmlDoc: Document, result: ExternalSystemValidation): void {
    result.requirements = [
      'Certificado digital válido',
   ...
   */
  private static validateForGeneral(xmlDoc: Document, result: ExternalSystemValidation): void {
    result.requirements = [
      'Certificado digital válido',
   ...
   */
  private static validateForExternalSystems(xmlDoc: Document): string[] {
   ...
   */
  private static validateXMLSyntax(xmlDoc: Document): string[] {
    const errors: string[] = [];
   ...
   */
  private static validateBasicStructure(xmlDoc: Document): string[] {
    const errors: string[] = [];
   ...
   */
  private static validateAgainstSchema(xmlDoc: Document): string[] {
    const errors: string[] = [];
   ...
   */
  private static validateBusinessRules(xmlDoc: Document): string[] {
    const errors: string[] = [];
   ...
   */
  private static validateInvoiceTotals(invoice: Element): string[] {
    const errors: string[] = [];
