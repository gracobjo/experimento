 ...
 */
async function addXAdEST(signatureElement: Element, options: SigningOptions, xmlDoc: Document): Promise<void> {
  if (!options.tsaUrl) {
 ...
 */
async function addXAdESC(signatureElement: Element, options: SigningOptions, xmlDoc: Document): Promise<void> {
  if (!options.ocspUrl) {
 ...
 */
async function addXAdESX(signatureElement: Element, options: SigningOptions, xmlDoc: Document): Promise<void> {
